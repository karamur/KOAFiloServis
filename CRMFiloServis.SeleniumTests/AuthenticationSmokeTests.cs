...
namespace CRMFiloServis.SeleniumTests;
...
public sealed class AuthenticationSmokeTests
{
    ...
    private sealed class LocalWebAppHost : IDisposable
    {
        ...
        private static string FindWebProjectPath()
        {
            ...
            {
                var candidate = Path.Combine(current.FullName, "CRMFiloServis.Web", "CRMFiloServis.Web.csproj");
            ...
            throw new FileNotFoundException("CRMFiloServis.Web.csproj bulunamadi.");
        }
    }
}
