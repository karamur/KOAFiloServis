...
{
    /// <inheritdoc />
    public partial class AddResimUrlToPiyasaIlan : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.RenameIndex(
                ...
                newName: "IX_AylikChecklistler_Yil_Ay_ChecklistTipi_SoforId_AracId_Guzer~");
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PlanlananBitisTarihi = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    GercekBitisTarihi = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                    BaslangicKm = table.Column<int>(type: "integer", nullable: true),
                    BitisKm = table.Column<int>(type: "integer", nullable: true),
                    GunlukFiyat = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                    ToplamTutar = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                    Depozito = table.Column<decimal>(type: "numeric(18,2)", nullable: true),
                    Durum = table.Column<int>(type: "integer", nullable: false),
                    OdemeDurumu = table.Column<int>(type: "integer", nullable: false),
                    TeslimAlanPersonelId = table.Column<int>(type: "integer", nullable: true),
                    TeslimEdenPersonelId = table.Column<int>(type: "integer", nullable: true),
                    Notlar = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    SozlesmeNo = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MusteriKiralamalar", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "PiyasaKaynaklar",
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    ...
                    AramaUrl = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    AramaParametreleri = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: true),
                    Selectors = table.Column<string>(type: "character varying(2000)", maxLength: 2000, nullable: true),
                    DesteklenenMarkalar = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    KaynakTipi = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PiyasaKaynaklar", x => x.Id);
                });
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_AylikOdemeGerceklesenler_AylikOdemePlanlari_AylikOdemePlani~",
                table: "AylikOdemeGerceklesenler",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_AylikOdemeGerceklesenler_BankaKasaHareketleri_BankaKasaHare~",
                table: "AylikOdemeGerceklesenler",
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.RenameIndex(
                ...
                table: "AylikChecklistler",
                newName: "IX_AylikChecklistler_Yil_Ay_ChecklistTipi_SoforId_AracId_GuzergahId");
