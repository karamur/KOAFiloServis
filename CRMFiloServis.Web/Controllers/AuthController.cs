...
public class AuthController : ControllerBase
{
    ...
    {
        var jwtSecret = _configuration["Jwt:Secret"] ?? "CRMFiloServis-Super-Secret-Key-2025-Minimum-32-Chars";
        var jwtIssuer = _configuration["Jwt:Issuer"] ?? "CRMFiloServis";
        var jwtAudience = _configuration["Jwt:Audience"] ?? "CRMFiloServis-API";
