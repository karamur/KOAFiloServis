...
public class ServisKiralamaService : IServisKiralamaService
{
    ...
    #region Kiralama Araç Ýþlemleri
    ...
    #region Servis Çalýþma Ýþlemleri
    ...
    public async Task<List<ServisCalismaKiralama>> HaftalikPlanOlusturAsync(int firmaId, DateTime haftaBaslangic)
    {
        ...
        // Önceki hafta çalýþmalarýný bul (tekrar eden güzergahlar için)
    ...
    public async Task<byte[]> ExportServisCalismaRaporuAsync(int? firmaId, DateTime baslangic, DateTime bitis)
    {
        ...
        var worksheet = package.Workbook.Worksheets.Add("Servis Çalýþma Raporu");

        // Baþlýk
        worksheet.Cells["A1"].Value = "SERVÝS ÇALIÞMA RAPORU";
        ...
        var basliklar = new[]
        {
            "Tarih", "Plaka", "Sahiplik", "Þoför", "Güzergah", "Müþteri Firma",
            "Servis Türü", "Çalýþma Bedeli", "Kira Bedeli", "Komisyon",
            "Net Kazanç", "Km", "Baþlangýç", "Bitiþ", "Durum"
        };
    ...
    public async Task<byte[]> ExportKiralamaAracListesiAsync(int firmaId)
    {
        ...
        var basliklar = new[] { "Plaka", "Marka/Model", "Araç Tipi", "Kiralayan", 
            "Baþlangýç", "Bitiþ", "Günlük Kira", "Sefer Kira", "Aylýk Kira", "Durum" };
    ...
    public async Task<byte[]> ExportAylikOzetAsync(int firmaId, int yil, int ay)
    {
        ...
        // Baþlýk
        worksheet.Cells["A1"].Value = $"{GetAyAdi(ay)} {yil} - SERVÝS ÇALIÞMA ÖZETÝ";
